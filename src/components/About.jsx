...
const About = () => {
  ...
  return (
    <>
      <section
        className="bg-darkSlateBlue text-center py-12 relative"
        id="about"
      >
        ...
        <div className="mx-auto px-4 md:px-6 flex max-w-7xl flex-col sm:flex-row justify-center items-center gap-8 z-10">
          ...
          >
            ...
            <p className="text-left text-lightGray text-sm leading-relaxed md:text-base md:leading-relaxed lg:text-lg lg:leading-relaxed">
              ...
              <br /> With a strong focus on creating seamless user experiences,
              I thrive on turning complex ideas into functional and intuitive
              digital solutions.
              <br /> Over the past year, I&apos;ve been honing my skills in web
              development, including technologies like HTML, CSS, JavaScript,
              and frameworks such as React. I enjoy experimenting with new
              technologies
